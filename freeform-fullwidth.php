...
<head>
	...
	<title>City of Lyons, KS - Freeform Fullwidth</title>
		...
		<div class="container">
			<div id="content-quick-links-wrapper" class="owl-carousel">
				<a href="./" class="content-quick-link">
					...
					<span>Forms</span>
				</a><!-- /.content-quick-link -->
				<a href="./" class="content-quick-link">
					<div class="content-quick-link-img" style="background:url('./_assets_/images/cql2.png') center no-repeat;background-size:cover;"></div>
					<span>Maps/GIS</span>
				</a><!-- /.content-quick-link -->
				<a href="./" class="content-quick-link">
					<div class="content-quick-link-img" style="background:url('./_assets_/images/cql3.png') center no-repeat;background-size:cover;"></div>
					<span>Report an Issue</span>
				</a><!-- /.content-quick-link -->
				<a href="./" class="content-quick-link">
					<div class="content-quick-link-img" style="background:url('./_assets_/images/cql4.png') center no-repeat;background-size:cover;"></div>
					<span>Agendas/Minutes</span>
				</a><!-- /.content-quick-link -->
				<a href="./" class="content-quick-link">
					<div class="content-quick-link-img" style="background:url('./_assets_/images/cql5.png') center no-repeat;background-size:cover;"></div>
